...
def test_week_chunks():
    got = cf.week_chunks("2026-01-02", "2026-01-20", 7)
    check("weekly chunking covers the range, no gaps/overlap",
          got == [("2026-01-02", "2026-01-08"), ("2026-01-09", "2026-01-15"),
                  ("2026-01-16", "2026-01-20")], str(got))
    check("single-day range = one chunk",
